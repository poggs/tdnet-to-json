 ...
 *         &lt;element ref="{http://xml.networkrail.co.uk/ns/2008/Train}OriginalLocationStanox"/>
 *         &lt;element ref="{http://xml.networkrail.co.uk/ns/2008/Train}OriginalWTTTimestamp"/>
...
@XmlRootElement(name = "TrainChangeLocationData")
public class TrainChangeLocationData {
    ...
    @XmlElement(name = "OriginalLocationStanox", required = true)
    protected String originalLocationStanox;
    @XmlElement(name = "OriginalWTTTimestamp", required = true)
    @XmlSchemaType(name = "dateTime")
